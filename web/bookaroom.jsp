    ...
    <head>
        ...
        <script type="text/javascript">
            function showUser(str)
            {
                ...
                xmlhttp.open("GET","months.jsp?duration="+str,true);
                xmlhttp.send();
            }
        </script>
    </head>
    <body>
        <h3><a href="index.jsp">Home</a>&nbsp;Book A Room!</h3>
        ...
        <form action="bookaroomprocess.jsp" method="POST">
            <h3>To Book Rooms Classes You need to Select:</h3><br />
