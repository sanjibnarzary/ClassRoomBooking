...
<html>
    ...
    <body>
        ...
        <font color="red">Warning!</font>
            <p>By deleting a user name all booked records associated with that user  will
            also be deleted. So be carefull :)
            </p>
        <%
                   out.println("  <h1>Remove An User</h1>");
                    Connection con = null;
                    try {
                        String[] room = null;
                        int i = 0;
                        ...
                        ResultSet rs = null;
                        if (!con.isClosed()) {
                            String del = "select username from user";
        ...
        <form method="POST" action="deleteuserprocess.jsp">
            <table><tr><td>Select Room to Delete</td><td>
                    ...
                    </td><td><input type="submit" value="Delete User" /></td></tr>
            </table>
        </form>
